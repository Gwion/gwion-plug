...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(0.14099999999999999f);
		fHslider1 = FAUSTFLOAT(0.54000000000000004f);
		fHslider2 = FAUSTFLOAT(0.71999999999999997f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Damp", &fHslider2, 0.720000029f, 0.0f, 1.0f, 0.0250000004f);
		ui_interface->addHorizontalSlider("RoomSize", &fHslider1, 0.540000021f, 0.0f, 1.0f, 0.0250000004f);
		ui_interface->addHorizontalSlider("Wet", &fHslider0, 0.141000003f, 0.0f, 1.0f, 0.0250000004f);
