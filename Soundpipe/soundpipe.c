...
GWION_IMPORT(Soundpipe) {
  ...
  if(!sp) {
    ...
    CHECK_B(set_module(vm->gwion, "Soundpipe", sp));
  }
  ...
  DECL_B(const Type, t_ftbl, = gwi_class_ini(gwi, "ftbl", NULL));
  ...
  GWI_B(gwi_func_end(gwi, ftbl_gen_composite, ae_flag_none))
  gwi_func_ini(gwi, "void", "_gen_file");
  gwi_func_arg(gwi, "int", "Size");
     gwinote(gwi, "filename");
     gwi_func_arg(gwi, "string", "_filename");
  GWI_B(gwi_func_end(gwi, ftbl_gen_file, ae_flag_none))
  ...
  GWI_B(gwi_func_end(gwi, ftbl_gen_gauss, ae_flag_none))
  ...
  gwi_func_arg(gwi, "int", "Size");
     ...
     gwi_func_arg(gwi, "string", "_argstring");
  GWI_B(gwi_func_end(gwi, ftbl_gen_line, ae_flag_none))
  ...
  gwi_func_arg(gwi, "int", "Size");
     ...
     gwi_func_arg(gwi, "string", "_argstring");
  GWI_B(gwi_func_end(gwi, ftbl_gen_sinesum, ae_flag_none))
  gwi_func_ini(gwi, "void", "_gen_triangle");
  gwi_func_arg(gwi, "int", "Size");
  GWI_B(gwi_func_end(gwi, ftbl_gen_triangle, ae_flag_none))
  gwi_func_ini(gwi, "void", "_gen_xline");
  gwi_func_arg(gwi, "int", "Size");
     gwinote(gwi, "A list of ordered xy pairs. X expects whole number integers, as they correlate to index positions in the ftable.");
     gwi_func_arg(gwi, "string", "_argstring");
  GWI_B(gwi_func_end(gwi, ftbl_gen_xline, ae_flag_none))
  ...
  DECL_B(const Type, t_adsr, = gwi_class_ini(gwi, "Adsr", "UGen"));
  SET_FLAG(t_adsr, final);
  gwi_class_xtor(gwi, NULL, adsr_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, adsr_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, adsr_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Attack time (in seconds)");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, adsr_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
  GWI_B(gwi_func_end(gwi, adsr_get_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
     gwinote(gwi, "Decay time (in seconds)");
     gwi_func_arg(gwi, "float", "_dec");
  GWI_B(gwi_func_end(gwi, adsr_set_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "sus");
  GWI_B(gwi_func_end(gwi, adsr_get_sus, ae_flag_none))
  gwi_func_ini(gwi, "float", "sus");
     gwinote(gwi, "Sustain (in range 0-1)");
     gwi_func_arg(gwi, "float", "_sus");
  GWI_B(gwi_func_end(gwi, adsr_set_sus, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
  GWI_B(gwi_func_end(gwi, adsr_get_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
     gwinote(gwi, "Release time (in seconds)");
     gwi_func_arg(gwi, "float", "_rel");
  GWI_B(gwi_func_end(gwi, adsr_set_rel, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Allpass filter");
     gwinote(gwi, "    Often used for the creation of reverb modules.");
  DECL_B(const Type, t_allpass, = gwi_class_ini(gwi, "Allpass", "UGen"));
  ...
  DECL_B(const Type, t_bal, = gwi_class_ini(gwi, "Bal", "UGen"));
  SET_FLAG(t_bal, final);
  gwi_class_xtor(gwi, NULL, bal_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, bal_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Physical model approximating the sound of a struck metal bar");
  DECL_B(const Type, t_bar, = gwi_class_ini(gwi, "Bar", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, bar_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "bcL");
  GWI_B(gwi_func_end(gwi, bar_get_bcL, ae_flag_none))
  gwi_func_ini(gwi, "float", "bcL");
     gwinote(gwi, "Boundary condition at left end of bar. 1 = clamped, 2 = pivoting, 3 = free");
     gwi_func_arg(gwi, "float", "_bcL");
  GWI_B(gwi_func_end(gwi, bar_set_bcL, ae_flag_none))
  gwi_func_ini(gwi, "float", "bcR");
  GWI_B(gwi_func_end(gwi, bar_get_bcR, ae_flag_none))
  gwi_func_ini(gwi, "float", "bcR");
     gwinote(gwi, "Boundary condition at right end of bar. 1 = clamped, 2 = pivoting, 3 = free");
     gwi_func_arg(gwi, "float", "_bcR");
  GWI_B(gwi_func_end(gwi, bar_set_bcR, ae_flag_none))
  gwi_func_ini(gwi, "float", "T30");
  GWI_B(gwi_func_end(gwi, bar_get_T30, ae_flag_none))
  gwi_func_ini(gwi, "float", "T30");
     gwinote(gwi, "30db decay time (in seconds).");
     gwi_func_arg(gwi, "float", "_T30");
  GWI_B(gwi_func_end(gwi, bar_set_T30, ae_flag_none))
  gwi_func_ini(gwi, "float", "scan");
  GWI_B(gwi_func_end(gwi, bar_get_scan, ae_flag_none))
  gwi_func_ini(gwi, "float", "scan");
     gwinote(gwi, "Speed of scanning the output location.");
     gwi_func_arg(gwi, "float", "_scan");
  GWI_B(gwi_func_end(gwi, bar_set_scan, ae_flag_none))
  gwi_func_ini(gwi, "float", "pos");
  GWI_B(gwi_func_end(gwi, bar_get_pos, ae_flag_none))
  gwi_func_ini(gwi, "float", "pos");
     gwinote(gwi, "Position along bar that strike occurs.");
     gwi_func_arg(gwi, "float", "_pos");
  GWI_B(gwi_func_end(gwi, bar_set_pos, ae_flag_none))
  gwi_func_ini(gwi, "float", "vel");
  GWI_B(gwi_func_end(gwi, bar_get_vel, ae_flag_none))
  gwi_func_ini(gwi, "float", "vel");
     gwinote(gwi, "Normalized strike velocity");
     gwi_func_arg(gwi, "float", "_vel");
  GWI_B(gwi_func_end(gwi, bar_set_vel, ae_flag_none))
  gwi_func_ini(gwi, "float", "wid");
  GWI_B(gwi_func_end(gwi, bar_get_wid, ae_flag_none))
  gwi_func_ini(gwi, "float", "wid");
     gwinote(gwi, "Spatial width of strike.");
     gwi_func_arg(gwi, "float", "_wid");
  GWI_B(gwi_func_end(gwi, bar_set_wid, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "A sweepable biquadratic general purpose filter");
     gwinote(gwi, "    ");
  DECL_B(const Type, t_biquad, = gwi_class_ini(gwi, "Biquad", "UGen"));
  SET_FLAG(t_biquad, final);
  gwi_class_xtor(gwi, NULL, biquad_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, biquad_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "b0");
  GWI_B(gwi_func_end(gwi, biquad_get_b0, ae_flag_none))
  gwi_func_ini(gwi, "float", "b0");
     gwinote(gwi, "biquad coefficient.");
     gwi_func_arg(gwi, "float", "_b0");
  GWI_B(gwi_func_end(gwi, biquad_set_b0, ae_flag_none))
  gwi_func_ini(gwi, "float", "b1");
  GWI_B(gwi_func_end(gwi, biquad_get_b1, ae_flag_none))
  gwi_func_ini(gwi, "float", "b1");
     gwinote(gwi, "biquad coefficient.");
     gwi_func_arg(gwi, "float", "_b1");
  GWI_B(gwi_func_end(gwi, biquad_set_b1, ae_flag_none))
  gwi_func_ini(gwi, "float", "b2");
  GWI_B(gwi_func_end(gwi, biquad_get_b2, ae_flag_none))
  gwi_func_ini(gwi, "float", "b2");
     gwinote(gwi, "biquad coefficient.");
     gwi_func_arg(gwi, "float", "_b2");
  GWI_B(gwi_func_end(gwi, biquad_set_b2, ae_flag_none))
  gwi_func_ini(gwi, "float", "a0");
  GWI_B(gwi_func_end(gwi, biquad_get_a0, ae_flag_none))
  gwi_func_ini(gwi, "float", "a0");
     gwinote(gwi, "biquad coefficient.");
     gwi_func_arg(gwi, "float", "_a0");
  GWI_B(gwi_func_end(gwi, biquad_set_a0, ae_flag_none))
  gwi_func_ini(gwi, "float", "a1");
  GWI_B(gwi_func_end(gwi, biquad_get_a1, ae_flag_none))
  gwi_func_ini(gwi, "float", "a1");
     gwinote(gwi, "biquad coefficient.");
     gwi_func_arg(gwi, "float", "_a1");
  GWI_B(gwi_func_end(gwi, biquad_set_a1, ae_flag_none))
  gwi_func_ini(gwi, "float", "a2");
  GWI_B(gwi_func_end(gwi, biquad_get_a2, ae_flag_none))
  gwi_func_ini(gwi, "float", "a2");
     gwinote(gwi, "biquad coefficient.");
     gwi_func_arg(gwi, "float", "_a2");
  GWI_B(gwi_func_end(gwi, biquad_set_a2, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Bipolar Scale");
     gwinote(gwi, "    This module scales from bipolar [-1, 1] to another range defined by min and max.");
  DECL_B(const Type, t_biscale, = gwi_class_ini(gwi, "Biscale", "UGen"));
  SET_FLAG(t_biscale, final);
  gwi_class_xtor(gwi, NULL, biscale_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, biscale_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
  GWI_B(gwi_func_end(gwi, biscale_get_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
     gwinote(gwi, "Minimum value to scale to.");
     gwi_func_arg(gwi, "float", "_min");
  GWI_B(gwi_func_end(gwi, biscale_set_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
  GWI_B(gwi_func_end(gwi, biscale_get_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
     gwinote(gwi, "Maximum value to scale to.");
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, biscale_set_max, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_bitcrush, = gwi_class_ini(gwi, "Bitcrush", "UGen"));
  SET_FLAG(t_bitcrush, final);
  gwi_class_xtor(gwi, NULL, bitcrush_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, bitcrush_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "bitdepth");
  GWI_B(gwi_func_end(gwi, bitcrush_get_bitdepth, ae_flag_none))
  gwi_func_ini(gwi, "float", "bitdepth");
  ...
  GWI_B(gwi_func_end(gwi, bitcrush_set_bitdepth, ae_flag_none))
  gwi_func_ini(gwi, "float", "srate");
  GWI_B(gwi_func_end(gwi, bitcrush_get_srate, ae_flag_none))
  gwi_func_ini(gwi, "float", "srate");
     gwinote(gwi, "Sampling rate.");
     gwi_func_arg(gwi, "float", "_srate");
  GWI_B(gwi_func_end(gwi, bitcrush_set_srate, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_blsaw, = gwi_class_ini(gwi, "Blsaw", "UGen"));
  SET_FLAG(t_blsaw, final);
  gwi_class_xtor(gwi, NULL, blsaw_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, blsaw_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, blsaw_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency, (range 0-20000)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, blsaw_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, blsaw_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude (range 0-1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, blsaw_set_amp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
     ...
     gwinote(gwi, "programming language.");
  DECL_B(const Type, t_blsquare, = gwi_class_ini(gwi, "Blsquare", "UGen"));
  SET_FLAG(t_blsquare, final);
  gwi_class_xtor(gwi, NULL, blsquare_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, blsquare_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, blsquare_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency, (range 0-20000)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, blsquare_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, blsquare_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude (range 0-1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, blsquare_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "width");
  GWI_B(gwi_func_end(gwi, blsquare_get_width, ae_flag_none))
  gwi_func_ini(gwi, "float", "width");
     gwinote(gwi, "Duty cycle width (range 0-1).");
     gwi_func_arg(gwi, "float", "_width");
  GWI_B(gwi_func_end(gwi, blsquare_set_width, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
     ...
     gwinote(gwi, "programming language.");
  DECL_B(const Type, t_bltriangle, = gwi_class_ini(gwi, "Bltriangle", "UGen"));
  SET_FLAG(t_bltriangle, final);
  gwi_class_xtor(gwi, NULL, bltriangle_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, bltriangle_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, bltriangle_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency, (range 0-20000)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, bltriangle_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, bltriangle_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude (range 0-1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, bltriangle_set_amp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Brownian noise generator.");
  DECL_B(const Type, t_brown, = gwi_class_ini(gwi, "Brown", "UGen"));
  SET_FLAG(t_brown, final);
  gwi_class_xtor(gwi, NULL, brown_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, brown_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Bandpass Butterworth filter");
  DECL_B(const Type, t_butbp, = gwi_class_ini(gwi, "Butbp", "UGen"));
  SET_FLAG(t_butbp, final);
  gwi_class_xtor(gwi, NULL, butbp_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, butbp_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, butbp_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Center Frequency. (in Hertz)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, butbp_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "bw");
  GWI_B(gwi_func_end(gwi, butbp_get_bw, ae_flag_none))
  gwi_func_ini(gwi, "float", "bw");
     gwinote(gwi, "Bandwidth. (in Hertz)");
     gwi_func_arg(gwi, "float", "_bw");
  GWI_B(gwi_func_end(gwi, butbp_set_bw, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Band-reject Butterworth filter");
  DECL_B(const Type, t_butbr, = gwi_class_ini(gwi, "Butbr", "UGen"));
  SET_FLAG(t_butbr, final);
  gwi_class_xtor(gwi, NULL, butbr_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, butbr_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, butbr_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Center Frequency. (in Hertz)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, butbr_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "bw");
  GWI_B(gwi_func_end(gwi, butbr_get_bw, ae_flag_none))
  gwi_func_ini(gwi, "float", "bw");
     gwinote(gwi, "Bandwidth. (in Hertz)");
     gwi_func_arg(gwi, "float", "_bw");
  GWI_B(gwi_func_end(gwi, butbr_set_bw, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Highpass Butterworth filter");
  DECL_B(const Type, t_buthp, = gwi_class_ini(gwi, "Buthp", "UGen"));
  SET_FLAG(t_buthp, final);
  gwi_class_xtor(gwi, NULL, buthp_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, buthp_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, buthp_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Cutoff Frequency.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, buthp_set_freq, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Lowpass Butterworth filter");
  DECL_B(const Type, t_butlp, = gwi_class_ini(gwi, "Butlp", "UGen"));
  SET_FLAG(t_butlp, final);
  gwi_class_xtor(gwi, NULL, butlp_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, butlp_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, butlp_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Cutoff Frequency.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, butlp_set_freq, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Applies clip-limiting to a signal");
  DECL_B(const Type, t_clip, = gwi_class_ini(gwi, "Clip", "UGen"));
  SET_FLAG(t_clip, final);
  gwi_class_xtor(gwi, NULL, clip_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, clip_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "lim");
  GWI_B(gwi_func_end(gwi, clip_get_lim, ae_flag_none))
  gwi_func_ini(gwi, "float", "lim");
     gwinote(gwi, "threshold / limiting value.");
     gwi_func_arg(gwi, "float", "_lim");
  GWI_B(gwi_func_end(gwi, clip_set_lim, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Resettable clock with subdivisions");
  DECL_B(const Type, t_clock, = gwi_class_ini(gwi, "Clock", "UGen"));
  SET_FLAG(t_clock, final);
  gwi_class_xtor(gwi, NULL, clock_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, clock_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "bpm");
  GWI_B(gwi_func_end(gwi, clock_get_bpm, ae_flag_none))
  gwi_func_ini(gwi, "float", "bpm");
     gwinote(gwi, "Clock tempo, in beats per minute.");
     gwi_func_arg(gwi, "float", "_bpm");
  GWI_B(gwi_func_end(gwi, clock_set_bpm, ae_flag_none))
  gwi_func_ini(gwi, "float", "subdiv");
  GWI_B(gwi_func_end(gwi, clock_get_subdiv, ae_flag_none))
  gwi_func_ini(gwi, "float", "subdiv");
     gwinote(gwi, "Clock subdivision. 2 = eighths, 4 = 16ths, etc.");
     gwi_func_arg(gwi, "float", "_subdiv");
  GWI_B(gwi_func_end(gwi, clock_set_subdiv, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Comb filter");
  DECL_B(const Type, t_comb, = gwi_class_ini(gwi, "Comb", "UGen"));
  SET_FLAG(t_comb, final);
  gwi_class_xtor(gwi, NULL, comb_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "The loop time of the filter, in seconds. This can also be thought of as the delay time.");
     gwi_func_arg(gwi, "float", "_looptime");
  GWI_B(gwi_func_end(gwi, comb_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "revtime");
  GWI_B(gwi_func_end(gwi, comb_get_revtime, ae_flag_none))
  gwi_func_ini(gwi, "float", "revtime");
     gwinote(gwi, "Reverberation time, in seconds (RT-60).");
     gwi_func_arg(gwi, "float", "_revtime");
  GWI_B(gwi_func_end(gwi, comb_set_revtime, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Compressor");
  DECL_B(const Type, t_compressor, = gwi_class_ini(gwi, "Compressor", "UGen"));
  SET_FLAG(t_compressor, final);
  gwi_class_xtor(gwi, NULL, compressor_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, compressor_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "ratio");
  GWI_B(gwi_func_end(gwi, compressor_get_ratio, ae_flag_none))
  gwi_func_ini(gwi, "float", "ratio");
     gwinote(gwi, "Ratio to compress with, a value > 1 will compress");
     gwi_func_arg(gwi, "float", "_ratio");
  GWI_B(gwi_func_end(gwi, compressor_set_ratio, ae_flag_none))
  gwi_func_ini(gwi, "float", "thresh");
  GWI_B(gwi_func_end(gwi, compressor_get_thresh, ae_flag_none))
  gwi_func_ini(gwi, "float", "thresh");
     gwinote(gwi, "Threshold (in dB) 0 = max");
     gwi_func_arg(gwi, "float", "_thresh");
  GWI_B(gwi_func_end(gwi, compressor_set_thresh, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, compressor_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Compressor attack");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, compressor_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
  GWI_B(gwi_func_end(gwi, compressor_get_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
     gwinote(gwi, "Compressor release");
     gwi_func_arg(gwi, "float", "_rel");
  GWI_B(gwi_func_end(gwi, compressor_set_rel, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_conv, = gwi_class_ini(gwi, "Conv", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, conv_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_diode, = gwi_class_ini(gwi, "Diode", "UGen"));
  SET_FLAG(t_diode, final);
  gwi_class_xtor(gwi, NULL, diode_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, diode_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, diode_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, diode_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
  GWI_B(gwi_func_end(gwi, diode_get_res, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
     gwi_func_arg(gwi, "float", "_res");
  GWI_B(gwi_func_end(gwi, diode_set_res, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_drip, = gwi_class_ini(gwi, "Drip", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, drip_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "num_tubes");
  GWI_B(gwi_func_end(gwi, drip_get_num_tubes, ae_flag_none))
  gwi_func_ini(gwi, "float", "num_tubes");
     gwinote(gwi, "Number of units.");
     gwi_func_arg(gwi, "float", "_num_tubes");
  GWI_B(gwi_func_end(gwi, drip_set_num_tubes, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, drip_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude.");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, drip_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "damp");
  GWI_B(gwi_func_end(gwi, drip_get_damp, ae_flag_none))
  gwi_func_ini(gwi, "float", "damp");
     gwinote(gwi, "The damping factor. Maximum value is 2.0.");
     gwi_func_arg(gwi, "float", "_damp");
  GWI_B(gwi_func_end(gwi, drip_set_damp, ae_flag_none))
  gwi_func_ini(gwi, "float", "shake_max");
  GWI_B(gwi_func_end(gwi, drip_get_shake_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "shake_max");
     gwinote(gwi, "The amount of energy to add back into the system.");
     gwi_func_arg(gwi, "float", "_shake_max");
  GWI_B(gwi_func_end(gwi, drip_set_shake_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, drip_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Main resonant frequency.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, drip_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq1");
  GWI_B(gwi_func_end(gwi, drip_get_freq1, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq1");
     gwinote(gwi, "The first resonant frequency.");
     gwi_func_arg(gwi, "float", "_freq1");
  GWI_B(gwi_func_end(gwi, drip_set_freq1, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq2");
  GWI_B(gwi_func_end(gwi, drip_get_freq2, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq2");
     gwinote(gwi, "The second resonant frequency.");
     gwi_func_arg(gwi, "float", "_freq2");
  GWI_B(gwi_func_end(gwi, drip_set_freq2, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, " Delta trigger");
     gwinote(gwi, "    This is able to create spaced out triggers. It is set off by a single trigger.");
  DECL_B(const Type, t_dtrig, = gwi_class_ini(gwi, "Dtrig", "UGen"));
  SET_FLAG(t_dtrig, final);
  gwi_class_xtor(gwi, NULL, dtrig_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "An ftable containing times in seconds.");
     gwi_func_arg(gwi, "ftbl", "_ft");
  GWI_B(gwi_func_end(gwi, dtrig_init, ae_flag_none))
  gwi_func_ini(gwi, "int", "loop");
  GWI_B(gwi_func_end(gwi, dtrig_get_loop, ae_flag_none))
  gwi_func_ini(gwi, "int", "loop");
     gwinote(gwi, "When set to 1, dtrig will wrap around and loop again.");
     gwi_func_arg(gwi, "int", "_loop");
  GWI_B(gwi_func_end(gwi, dtrig_set_loop, ae_flag_none))
  gwi_func_ini(gwi, "float", "delay");
  GWI_B(gwi_func_end(gwi, dtrig_get_delay, ae_flag_none))
  gwi_func_ini(gwi, "float", "delay");
  ...
  GWI_B(gwi_func_end(gwi, dtrig_set_delay, ae_flag_none))
  gwi_func_ini(gwi, "float", "scale");
  GWI_B(gwi_func_end(gwi, dtrig_get_scale, ae_flag_none))
  gwi_func_ini(gwi, "float", "scale");
     ...
     gwi_func_arg(gwi, "float", "_scale");
  GWI_B(gwi_func_end(gwi, dtrig_set_scale, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "A series of random impulses");
  DECL_B(const Type, t_dust, = gwi_class_ini(gwi, "Dust", "UGen"));
  SET_FLAG(t_dust, final);
  gwi_class_xtor(gwi, NULL, dust_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, dust_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, dust_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, dust_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "density");
  GWI_B(gwi_func_end(gwi, dust_get_density, ae_flag_none))
  gwi_func_ini(gwi, "float", "density");
     gwi_func_arg(gwi, "float", "_density");
  GWI_B(gwi_func_end(gwi, dust_set_density, ae_flag_none))
  gwi_func_ini(gwi, "int", "bipolar");
  GWI_B(gwi_func_end(gwi, dust_get_bipolar, ae_flag_none))
  gwi_func_ini(gwi, "int", "bipolar");
     gwinote(gwi, "Bipolar flag. A non-zero makes the signal bipolar as opposed to unipolar. ");
     gwi_func_arg(gwi, "int", "_bipolar");
  GWI_B(gwi_func_end(gwi, dust_set_bipolar, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
     ...
     gwinote(gwi, "    ");
  DECL_B(const Type, t_eqfil, = gwi_class_ini(gwi, "Eqfil", "UGen"));
  SET_FLAG(t_eqfil, final);
  gwi_class_xtor(gwi, NULL, eqfil_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, eqfil_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, eqfil_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "The center frequency of the filter");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, eqfil_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "bw");
  GWI_B(gwi_func_end(gwi, eqfil_get_bw, ae_flag_none))
  gwi_func_ini(gwi, "float", "bw");
     gwinote(gwi, "The peak/notch bandwidth in Hertz");
     gwi_func_arg(gwi, "float", "_bw");
  GWI_B(gwi_func_end(gwi, eqfil_set_bw, ae_flag_none))
  gwi_func_ini(gwi, "float", "gain");
  GWI_B(gwi_func_end(gwi, eqfil_get_gain, ae_flag_none))
  gwi_func_ini(gwi, "float", "gain");
     gwinote(gwi, "The peak/notch gain");
     gwi_func_arg(gwi, "float", "_gain");
  GWI_B(gwi_func_end(gwi, eqfil_set_gain, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_expon, = gwi_class_ini(gwi, "Expon", "UGen"));
  SET_FLAG(t_expon, final);
  gwi_class_xtor(gwi, NULL, expon_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, expon_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "a");
  GWI_B(gwi_func_end(gwi, expon_get_a, ae_flag_none))
  gwi_func_ini(gwi, "float", "a");
     gwinote(gwi, "Inital point.");
     gwi_func_arg(gwi, "float", "_a");
  GWI_B(gwi_func_end(gwi, expon_set_a, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
  GWI_B(gwi_func_end(gwi, expon_get_dur, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
     gwinote(gwi, "Duration (in seconds)");
     gwi_func_arg(gwi, "float", "_dur");
  GWI_B(gwi_func_end(gwi, expon_set_dur, ae_flag_none))
  gwi_func_ini(gwi, "float", "b");
  GWI_B(gwi_func_end(gwi, expon_get_b, ae_flag_none))
  gwi_func_ini(gwi, "float", "b");
     gwinote(gwi, "End point");
     gwi_func_arg(gwi, "float", "_b");
  GWI_B(gwi_func_end(gwi, expon_set_b, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Produces sinusoid bursts for granular and formant synthesis");
  DECL_B(const Type, t_fof, = gwi_class_ini(gwi, "Fof", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, fof_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, fof_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Overall amplitude");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, fof_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "fund");
  GWI_B(gwi_func_end(gwi, fof_get_fund, ae_flag_none))
  gwi_func_ini(gwi, "float", "fund");
     gwinote(gwi, "Fundamental frequency");
     gwi_func_arg(gwi, "float", "_fund");
  GWI_B(gwi_func_end(gwi, fof_set_fund, ae_flag_none))
  gwi_func_ini(gwi, "float", "form");
  GWI_B(gwi_func_end(gwi, fof_get_form, ae_flag_none))
  gwi_func_ini(gwi, "float", "form");
     gwinote(gwi, "Formant frequency.");
     gwi_func_arg(gwi, "float", "_form");
  GWI_B(gwi_func_end(gwi, fof_set_form, ae_flag_none))
  gwi_func_ini(gwi, "float", "oct");
  GWI_B(gwi_func_end(gwi, fof_get_oct, ae_flag_none))
  gwi_func_ini(gwi, "float", "oct");
  ...
  GWI_B(gwi_func_end(gwi, fof_set_oct, ae_flag_none))
  gwi_func_ini(gwi, "float", "band");
  GWI_B(gwi_func_end(gwi, fof_get_band, ae_flag_none))
  gwi_func_ini(gwi, "float", "band");
  ...
  GWI_B(gwi_func_end(gwi, fof_set_band, ae_flag_none))
  gwi_func_ini(gwi, "float", "ris");
  GWI_B(gwi_func_end(gwi, fof_get_ris, ae_flag_none))
  gwi_func_ini(gwi, "float", "ris");
     gwinote(gwi, "Rise of sinusoid burst (in seconds)");
     gwi_func_arg(gwi, "float", "_ris");
  GWI_B(gwi_func_end(gwi, fof_set_ris, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
  GWI_B(gwi_func_end(gwi, fof_get_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
     gwinote(gwi, "Decay of the sinusoid burst (in seconds).");
     gwi_func_arg(gwi, "float", "_dec");
  GWI_B(gwi_func_end(gwi, fof_set_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
  GWI_B(gwi_func_end(gwi, fof_get_dur, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
     gwinote(gwi, "OVerall duration of sinusoid burst (in seconds).");
     gwi_func_arg(gwi, "float", "_dur");
  GWI_B(gwi_func_end(gwi, fof_set_dur, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_fofilt, = gwi_class_ini(gwi, "Fofilt", "UGen"));
  SET_FLAG(t_fofilt, final);
  gwi_class_xtor(gwi, NULL, fofilt_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, fofilt_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, fofilt_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Center frequency.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, fofilt_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, fofilt_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Impulse response attack time (in seconds).");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, fofilt_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
  GWI_B(gwi_func_end(gwi, fofilt_get_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
     gwinote(gwi, "Impulse reponse decay time (in seconds)");
     gwi_func_arg(gwi, "float", "_dec");
  GWI_B(gwi_func_end(gwi, fofilt_set_dec, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Sucession of grains from data in a stored function table");
  DECL_B(const Type, t_fog, = gwi_class_ini(gwi, "Fog", "UGen"));
  ...
  gwi_func_ini(gwi, "auto", "new");
     ...
     gwinote(gwi, "Phase");
     gwi_func_arg(gwi, "float", "_iphs");
  GWI_B(gwi_func_end(gwi, fog_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, fog_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Overall amplitude");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, fog_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "dens");
  GWI_B(gwi_func_end(gwi, fog_get_dens, ae_flag_none))
  gwi_func_ini(gwi, "float", "dens");
     gwinote(gwi, "Density. The frequency of grains/second.");
     gwi_func_arg(gwi, "float", "_dens");
  GWI_B(gwi_func_end(gwi, fog_set_dens, ae_flag_none))
  gwi_func_ini(gwi, "float", "trans");
  GWI_B(gwi_func_end(gwi, fog_get_trans, ae_flag_none))
  gwi_func_ini(gwi, "float", "trans");
     gwinote(gwi, "Transposition, in terms of playback speed");
     gwi_func_arg(gwi, "float", "_trans");
  GWI_B(gwi_func_end(gwi, fog_set_trans, ae_flag_none))
  gwi_func_ini(gwi, "float", "spd");
  GWI_B(gwi_func_end(gwi, fog_get_spd, ae_flag_none))
  gwi_func_ini(gwi, "float", "spd");
     gwinote(gwi, "Starting sample index, normalized 0-1.");
     gwi_func_arg(gwi, "float", "_spd");
  GWI_B(gwi_func_end(gwi, fog_set_spd, ae_flag_none))
  gwi_func_ini(gwi, "float", "oct");
  GWI_B(gwi_func_end(gwi, fog_get_oct, ae_flag_none))
  gwi_func_ini(gwi, "float", "oct");
     gwinote(gwi, "Octaviation index, if greater than zero, lowers the effective fund frequency by attenuating odd-numbered sine bursts. whole numbers are full octaves. fractions transpositional.");
     gwi_func_arg(gwi, "float", "_oct");
  GWI_B(gwi_func_end(gwi, fog_set_oct, ae_flag_none))
  gwi_func_ini(gwi, "float", "band");
  GWI_B(gwi_func_end(gwi, fog_get_band, ae_flag_none))
  gwi_func_ini(gwi, "float", "band");
     gwinote(gwi, "Bandwidth (in -6db) expressed in Hz. The bandwidth determines the rate of exponential decay throughout the sineburst, before the enveloping is applied.");
     gwi_func_arg(gwi, "float", "_band");
  GWI_B(gwi_func_end(gwi, fog_set_band, ae_flag_none))
  gwi_func_ini(gwi, "float", "ris");
  GWI_B(gwi_func_end(gwi, fog_get_ris, ae_flag_none))
  gwi_func_ini(gwi, "float", "ris");
     gwinote(gwi, "Rise of sinusoid burst (in seconds)");
     gwi_func_arg(gwi, "float", "_ris");
  GWI_B(gwi_func_end(gwi, fog_set_ris, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
  GWI_B(gwi_func_end(gwi, fog_get_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
     gwinote(gwi, "Decay of the sinusoid burst (in seconds).");
     gwi_func_arg(gwi, "float", "_dec");
  GWI_B(gwi_func_end(gwi, fog_set_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
  GWI_B(gwi_func_end(gwi, fog_get_dur, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
     gwinote(gwi, "OVerall duration of sinusoid burst (in seconds).");
     gwi_func_arg(gwi, "float", "_dur");
  GWI_B(gwi_func_end(gwi, fog_set_dur, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Adds artificial foldover to an audio signal");
     gwinote(gwi, "    Primarily created for use with Decimator.");
  DECL_B(const Type, t_fold, = gwi_class_ini(gwi, "Fold", "UGen"));
  SET_FLAG(t_fold, final);
  gwi_class_xtor(gwi, NULL, fold_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, fold_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "incr");
  GWI_B(gwi_func_end(gwi, fold_get_incr, ae_flag_none))
  gwi_func_ini(gwi, "float", "incr");
     gwinote(gwi, "Increment");
     gwi_func_arg(gwi, "float", "_incr");
  GWI_B(gwi_func_end(gwi, fold_set_incr, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_fosc, = gwi_class_ini(gwi, "Fosc", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, fosc_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, fosc_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency (in Hz)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, fosc_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, fosc_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude (typically a value between 0 and 1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, fosc_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "car");
  GWI_B(gwi_func_end(gwi, fosc_get_car, ae_flag_none))
  gwi_func_ini(gwi, "float", "car");
     gwinote(gwi, "Carrier frequency, expressed as a ratio number in C:M ratio. Typically an integer.");
     gwi_func_arg(gwi, "float", "_car");
  GWI_B(gwi_func_end(gwi, fosc_set_car, ae_flag_none))
  gwi_func_ini(gwi, "float", "mod");
  GWI_B(gwi_func_end(gwi, fosc_get_mod, ae_flag_none))
  gwi_func_ini(gwi, "float", "mod");
     gwinote(gwi, "Modulator frequency, expressed as a ratio number in C:M ratio. Typically an integer.");
     gwi_func_arg(gwi, "float", "_mod");
  GWI_B(gwi_func_end(gwi, fosc_set_mod, ae_flag_none))
  gwi_func_ini(gwi, "float", "indx");
  GWI_B(gwi_func_end(gwi, fosc_get_indx, ae_flag_none))
  gwi_func_ini(gwi, "float", "indx");
  ...
  GWI_B(gwi_func_end(gwi, fosc_set_indx, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_gbuzz, = gwi_class_ini(gwi, "Gbuzz", "UGen"));
  ...
  gwi_func_ini(gwi, "auto", "new");
     ...
     gwi_func_arg(gwi, "float", "_iphs");
  GWI_B(gwi_func_end(gwi, gbuzz_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, gbuzz_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency, in Hertz.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, gbuzz_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, gbuzz_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude (Typically a value between 0 and 1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, gbuzz_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "nharm");
  GWI_B(gwi_func_end(gwi, gbuzz_get_nharm, ae_flag_none))
  gwi_func_ini(gwi, "float", "nharm");
     gwinote(gwi, "Number of harmonics.");
     gwi_func_arg(gwi, "float", "_nharm");
  GWI_B(gwi_func_end(gwi, gbuzz_set_nharm, ae_flag_none))
  gwi_func_ini(gwi, "float", "lharm");
  GWI_B(gwi_func_end(gwi, gbuzz_get_lharm, ae_flag_none))
  gwi_func_ini(gwi, "float", "lharm");
     gwinote(gwi, "Lowest harmonic present. This should be a whole number integer.");
     gwi_func_arg(gwi, "float", "_lharm");
  GWI_B(gwi_func_end(gwi, gbuzz_set_lharm, ae_flag_none))
  gwi_func_ini(gwi, "float", "mul");
  GWI_B(gwi_func_end(gwi, gbuzz_get_mul, ae_flag_none))
  gwi_func_ini(gwi, "float", "mul");
     gwinote(gwi, "Multiplier. This determines the relative strength of each harmonic.");
     gwi_func_arg(gwi, "float", "_mul");
  GWI_B(gwi_func_end(gwi, gbuzz_set_mul, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_hilbert, = gwi_class_ini(gwi, "Hilbert", "UGen"));
  SET_FLAG(t_hilbert, final);
  gwi_class_xtor(gwi, NULL, hilbert_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, hilbert_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_in, = gwi_class_ini(gwi, "In", "UGen"));
  SET_FLAG(t_in, final);
  gwi_class_xtor(gwi, NULL, in_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, in_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_incr, = gwi_class_ini(gwi, "Incr", "UGen"));
  SET_FLAG(t_incr, final);
  gwi_class_xtor(gwi, NULL, incr_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "Initial value");
     gwi_func_arg(gwi, "float", "_val");
  GWI_B(gwi_func_end(gwi, incr_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "step");
  GWI_B(gwi_func_end(gwi, incr_get_step, ae_flag_none))
  gwi_func_ini(gwi, "float", "step");
     gwinote(gwi, "Step value to increment by.");
     gwi_func_arg(gwi, "float", "_step");
  GWI_B(gwi_func_end(gwi, incr_set_step, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
  GWI_B(gwi_func_end(gwi, incr_get_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
     gwinote(gwi, "Minimum value");
     gwi_func_arg(gwi, "float", "_min");
  GWI_B(gwi_func_end(gwi, incr_set_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
  GWI_B(gwi_func_end(gwi, incr_get_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
     gwinote(gwi, "Maximum value");
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, incr_set_max, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_jcrev, = gwi_class_ini(gwi, "Jcrev", "UGen"));
  SET_FLAG(t_jcrev, final);
  gwi_class_xtor(gwi, NULL, jcrev_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, jcrev_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "A signal with random fluctuations");
     gwinote(gwi, "     This is useful for emulating jitter found in analogue equipment. ");
  DECL_B(const Type, t_jitter, = gwi_class_ini(gwi, "Jitter", "UGen"));
  SET_FLAG(t_jitter, final);
  gwi_class_xtor(gwi, NULL, jitter_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, jitter_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, jitter_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "The amplitude of the line. Will produce values in the range of (+/-)amp.");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, jitter_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "cpsMin");
  GWI_B(gwi_func_end(gwi, jitter_get_cpsMin, ae_flag_none))
  gwi_func_ini(gwi, "float", "cpsMin");
     gwinote(gwi, "The minimum frequency of change in Hz.");
     gwi_func_arg(gwi, "float", "_cpsMin");
  GWI_B(gwi_func_end(gwi, jitter_set_cpsMin, ae_flag_none))
  gwi_func_ini(gwi, "float", "cpsMax");
  GWI_B(gwi_func_end(gwi, jitter_get_cpsMax, ae_flag_none))
  gwi_func_ini(gwi, "float", "cpsMax");
     gwinote(gwi, "The maximum frequency of change in Hz.");
     gwi_func_arg(gwi, "float", "_cpsMax");
  GWI_B(gwi_func_end(gwi, jitter_set_cpsMax, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Produce a line segment with linear slope");
     gwinote(gwi, "This will generate a line from value A to value B in given amount of time. ");
     gwinote(gwi, "When it reaches it's target, it will stay at that value. ");
  DECL_B(const Type, t_line, = gwi_class_ini(gwi, "Line", "UGen"));
  SET_FLAG(t_line, final);
  gwi_class_xtor(gwi, NULL, line_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, line_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "a");
  GWI_B(gwi_func_end(gwi, line_get_a, ae_flag_none))
  gwi_func_ini(gwi, "float", "a");
     gwinote(gwi, "Inital point.");
     gwi_func_arg(gwi, "float", "_a");
  GWI_B(gwi_func_end(gwi, line_set_a, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
  GWI_B(gwi_func_end(gwi, line_get_dur, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
     gwinote(gwi, "Duration (in seconds)");
     gwi_func_arg(gwi, "float", "_dur");
  GWI_B(gwi_func_end(gwi, line_set_dur, ae_flag_none))
  gwi_func_ini(gwi, "float", "b");
  GWI_B(gwi_func_end(gwi, line_get_b, ae_flag_none))
  gwi_func_ini(gwi, "float", "b");
     gwinote(gwi, "End point");
     gwi_func_arg(gwi, "float", "_b");
  GWI_B(gwi_func_end(gwi, line_set_b, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_lpc, = gwi_class_ini(gwi, "Lpc", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, lpc_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "3-pole (18 db/oct slope) Low-Pass filter with resonance and tanh distortion");
  DECL_B(const Type, t_lpf18, = gwi_class_ini(gwi, "Lpf18", "UGen"));
  SET_FLAG(t_lpf18, final);
  gwi_class_xtor(gwi, NULL, lpf18_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, lpf18_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "cutoff");
  GWI_B(gwi_func_end(gwi, lpf18_get_cutoff, ae_flag_none))
  gwi_func_ini(gwi, "float", "cutoff");
     gwinote(gwi, "Filter cutoff frequency, in Hertz");
     gwi_func_arg(gwi, "float", "_cutoff");
  GWI_B(gwi_func_end(gwi, lpf18_set_cutoff, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
  GWI_B(gwi_func_end(gwi, lpf18_get_res, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
     gwinote(gwi, "Resonance. Expects a value in the range 0-1. A value of 1.0 will self oscillate at the cutoff frequency.");
     gwi_func_arg(gwi, "float", "_res");
  GWI_B(gwi_func_end(gwi, lpf18_set_res, ae_flag_none))
  gwi_func_ini(gwi, "float", "dist");
  GWI_B(gwi_func_end(gwi, lpf18_get_dist, ae_flag_none))
  gwi_func_ini(gwi, "float", "dist");
     gwinote(gwi, "Distortion amount.");
     gwi_func_arg(gwi, "float", "_dist");
  GWI_B(gwi_func_end(gwi, lpf18_set_dist, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_maygate, = gwi_class_ini(gwi, "Maygate", "UGen"));
  SET_FLAG(t_maygate, final);
  gwi_class_xtor(gwi, NULL, maygate_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, maygate_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "prob");
  GWI_B(gwi_func_end(gwi, maygate_get_prob, ae_flag_none))
  gwi_func_ini(gwi, "float", "prob");
  ...
  GWI_B(gwi_func_end(gwi, maygate_set_prob, ae_flag_none))
  gwi_func_ini(gwi, "int", "mode");
  GWI_B(gwi_func_end(gwi, maygate_get_mode, ae_flag_none))
  gwi_func_ini(gwi, "int", "mode");
  ...
  GWI_B(gwi_func_end(gwi, maygate_set_mode, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_metro, = gwi_class_ini(gwi, "Metro", "UGen"));
  SET_FLAG(t_metro, final);
  gwi_class_xtor(gwi, NULL, metro_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, metro_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, metro_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "The frequency to repeat.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, metro_set_freq, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_mincer, = gwi_class_ini(gwi, "Mincer", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, mincer_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "time");
  GWI_B(gwi_func_end(gwi, mincer_get_time, ae_flag_none))
  gwi_func_ini(gwi, "float", "time");
     gwinote(gwi, "Position in time. When non-changing it will do a spectral freeze of a the current point in time.");
     gwi_func_arg(gwi, "float", "_time");
  GWI_B(gwi_func_end(gwi, mincer_set_time, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, mincer_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude.");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, mincer_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "pitch");
  GWI_B(gwi_func_end(gwi, mincer_get_pitch, ae_flag_none))
  gwi_func_ini(gwi, "float", "pitch");
     gwinote(gwi, "Pitch ratio. A value of. 1  normal, 2 is double speed, 0.5 is halfspeed, etc.");
     gwi_func_arg(gwi, "float", "_pitch");
  GWI_B(gwi_func_end(gwi, mincer_set_pitch, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_mode, = gwi_class_ini(gwi, "Mode", "UGen"));
  SET_FLAG(t_mode, final);
  gwi_class_xtor(gwi, NULL, mode_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, mode_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, mode_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Resonant frequency of the filter.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, mode_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "q");
  GWI_B(gwi_func_end(gwi, mode_get_q, ae_flag_none))
  gwi_func_ini(gwi, "float", "q");
     gwinote(gwi, "Quality factor of the filter. Roughly equal to q/freq.");
     gwi_func_arg(gwi, "float", "_q");
  GWI_B(gwi_func_end(gwi, mode_set_q, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Low pass resonant filter based on the Moogladder filter");
  DECL_B(const Type, t_moogladder, = gwi_class_ini(gwi, "Moogladder", "UGen"));
  SET_FLAG(t_moogladder, final);
  gwi_class_xtor(gwi, NULL, moogladder_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, moogladder_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, moogladder_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Filter cutoff frequency.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, moogladder_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
  GWI_B(gwi_func_end(gwi, moogladder_get_res, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
     gwinote(gwi, "Filter resonance");
     gwi_func_arg(gwi, "float", "_res");
  GWI_B(gwi_func_end(gwi, moogladder_set_res, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "White noise generator");
  DECL_B(const Type, t_noise, = gwi_class_ini(gwi, "Noise", "UGen"));
  SET_FLAG(t_noise, final);
  gwi_class_xtor(gwi, NULL, noise_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, noise_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, noise_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude. (Value between 0-1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, noise_set_amp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_nsmp, = gwi_class_ini(gwi, "Nsmp", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, nsmp_init, ae_flag_none))
  gwi_func_ini(gwi, "int", "index");
  GWI_B(gwi_func_end(gwi, nsmp_get_index, ae_flag_none))
  gwi_func_ini(gwi, "int", "index");
  ...
  GWI_B(gwi_func_end(gwi, nsmp_set_index, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, " Table-lookup oscilator with linear interpolation");
  DECL_B(const Type, t_osc, = gwi_class_ini(gwi, "Osc", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, osc_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, osc_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency (in Hz)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, osc_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, osc_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude (typically a value between 0 and 1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, osc_set_amp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_oscmorph, = gwi_class_ini(gwi, "Oscmorph", "UGen"));
  ...
  gwi_func_ini(gwi, "auto", "new");
     ...
     gwinote(gwi, "Initial phase of waveform, expects a value 0-1");
     gwi_func_arg(gwi, "float", "_phase");
  GWI_B(gwi_func_end(gwi, oscmorph_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, oscmorph_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency (in Hz)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, oscmorph_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, oscmorph_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude (typically a value between 0 and 1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, oscmorph_set_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "wtpos");
  GWI_B(gwi_func_end(gwi, oscmorph_get_wtpos, ae_flag_none))
  gwi_func_ini(gwi, "float", "wtpos");
     gwinote(gwi, "Wavetable position. (scaled 0-1)");
     gwi_func_arg(gwi, "float", "_wtpos");
  GWI_B(gwi_func_end(gwi, oscmorph_set_wtpos, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Panner");
  DECL_B(const Type, t_pan2, = gwi_class_ini(gwi, "Pan2", "UGen"));
  SET_FLAG(t_pan2, final);
  gwi_class_xtor(gwi, NULL, pan2_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, pan2_init, ae_flag_none))
  gwi_func_ini(gwi, "int", "type");
  GWI_B(gwi_func_end(gwi, pan2_get_type, ae_flag_none))
  gwi_func_ini(gwi, "int", "type");
  ...
  GWI_B(gwi_func_end(gwi, pan2_set_type, ae_flag_none))
  gwi_func_ini(gwi, "float", "pan");
  GWI_B(gwi_func_end(gwi, pan2_get_pan, ae_flag_none))
  gwi_func_ini(gwi, "float", "pan");
     gwinote(gwi, "Panning. A value of -1 is hard left, and a value of 1 is hard right, and 0 is center.");
     gwi_func_arg(gwi, "float", "_pan");
  GWI_B(gwi_func_end(gwi, pan2_set_pan, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Stereo Panner");
  DECL_B(const Type, t_panst, = gwi_class_ini(gwi, "Panst", "UGen"));
  SET_FLAG(t_panst, final);
  gwi_class_xtor(gwi, NULL, panst_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, panst_init, ae_flag_none))
  gwi_func_ini(gwi, "int", "type");
  GWI_B(gwi_func_end(gwi, panst_get_type, ae_flag_none))
  gwi_func_ini(gwi, "int", "type");
     gwinote(gwi, "Panning type. 0 = equal power, 1 = square root, 2 = linear,");
     gwinote(gwi, "3 = alternative equal power. Values outside this range will wrap. ");
     gwi_func_arg(gwi, "int", "_type");
  GWI_B(gwi_func_end(gwi, panst_set_type, ae_flag_none))
  gwi_func_ini(gwi, "float", "pan");
  GWI_B(gwi_func_end(gwi, panst_get_pan, ae_flag_none))
  gwi_func_ini(gwi, "float", "pan");
     gwinote(gwi, "Panning. A value of -1 is hard left, and a value of 1 is hard right.");
     gwi_func_arg(gwi, "float", "_pan");
  GWI_B(gwi_func_end(gwi, panst_set_pan, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Parametric Equalizer");
     gwinote(gwi, "This is an implementation of Zoelzer's parametric equalizer filter.");
  DECL_B(const Type, t_pareq, = gwi_class_ini(gwi, "Pareq", "UGen"));
  SET_FLAG(t_pareq, final);
  gwi_class_xtor(gwi, NULL, pareq_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, pareq_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "fc");
  GWI_B(gwi_func_end(gwi, pareq_get_fc, ae_flag_none))
  gwi_func_ini(gwi, "float", "fc");
     gwinote(gwi, "Center frequency in peak mode, corner frequency in shelving mode.");
     gwi_func_arg(gwi, "float", "_fc");
  GWI_B(gwi_func_end(gwi, pareq_set_fc, ae_flag_none))
  gwi_func_ini(gwi, "float", "v");
  GWI_B(gwi_func_end(gwi, pareq_get_v, ae_flag_none))
  gwi_func_ini(gwi, "float", "v");
  ...
  GWI_B(gwi_func_end(gwi, pareq_set_v, ae_flag_none))
  gwi_func_ini(gwi, "float", "q");
  GWI_B(gwi_func_end(gwi, pareq_get_q, ae_flag_none))
  gwi_func_ini(gwi, "float", "q");
     gwinote(gwi, "Q of the filter. sqrt(0.5) is no resonance.");
     gwi_func_arg(gwi, "float", "_q");
  GWI_B(gwi_func_end(gwi, pareq_set_q, ae_flag_none))
  gwi_func_ini(gwi, "float", "mode");
  GWI_B(gwi_func_end(gwi, pareq_get_mode, ae_flag_none))
  gwi_func_ini(gwi, "float", "mode");
     gwinote(gwi, "EQ mode. 0 = peak, 1 = low shelving, 2 = high shelving");
     gwi_func_arg(gwi, "float", "_mode");
  GWI_B(gwi_func_end(gwi, pareq_set_mode, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_paulstretch, = gwi_class_ini(gwi, "Paulstretch", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, paulstretch_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_pdhalf, = gwi_class_ini(gwi, "Pdhalf", "UGen"));
  SET_FLAG(t_pdhalf, final);
  gwi_class_xtor(gwi, NULL, pdhalf_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, pdhalf_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "amount");
  GWI_B(gwi_func_end(gwi, pdhalf_get_amount, ae_flag_none))
  gwi_func_ini(gwi, "float", "amount");
     gwinote(gwi, "Amount of distortion, within the range [-1, 1]. 0 is no distortion.");
     gwi_func_arg(gwi, "float", "_amount");
  GWI_B(gwi_func_end(gwi, pdhalf_set_amount, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_peaklim, = gwi_class_ini(gwi, "Peaklim", "UGen"));
  SET_FLAG(t_peaklim, final);
  gwi_class_xtor(gwi, NULL, peaklim_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, peaklim_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, peaklim_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Attack time, in seconds");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, peaklim_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
  GWI_B(gwi_func_end(gwi, peaklim_get_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
     gwinote(gwi, "Release time, in seconds");
     gwi_func_arg(gwi, "float", "_rel");
  GWI_B(gwi_func_end(gwi, peaklim_set_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "thresh");
  GWI_B(gwi_func_end(gwi, peaklim_get_thresh, ae_flag_none))
  gwi_func_ini(gwi, "float", "thresh");
     gwinote(gwi, "Threshold, in dB");
     gwi_func_arg(gwi, "float", "_thresh");
  GWI_B(gwi_func_end(gwi, peaklim_set_thresh, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_phaser, = gwi_class_ini(gwi, "Phaser", "UGen"));
  SET_FLAG(t_phaser, final);
  gwi_class_xtor(gwi, NULL, phaser_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, phaser_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "MaxNotch1Freq");
  GWI_B(gwi_func_end(gwi, phaser_get_MaxNotch1Freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "MaxNotch1Freq");
     gwinote(gwi, "Between 20 and 10000");
     gwi_func_arg(gwi, "float", "_MaxNotch1Freq");
  GWI_B(gwi_func_end(gwi, phaser_set_MaxNotch1Freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "MinNotch1Freq");
  GWI_B(gwi_func_end(gwi, phaser_get_MinNotch1Freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "MinNotch1Freq");
     gwinote(gwi, "Between 20 and 5000");
     gwi_func_arg(gwi, "float", "_MinNotch1Freq");
  GWI_B(gwi_func_end(gwi, phaser_set_MinNotch1Freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "Notch_width");
  GWI_B(gwi_func_end(gwi, phaser_get_Notch_width, ae_flag_none))
  gwi_func_ini(gwi, "float", "Notch_width");
     gwinote(gwi, "Between 10 and 5000");
     gwi_func_arg(gwi, "float", "_Notch_width");
  GWI_B(gwi_func_end(gwi, phaser_set_Notch_width, ae_flag_none))
  gwi_func_ini(gwi, "float", "NotchFreq");
  GWI_B(gwi_func_end(gwi, phaser_get_NotchFreq, ae_flag_none))
  gwi_func_ini(gwi, "float", "NotchFreq");
     gwinote(gwi, "Between 1.1 and 4");
     gwi_func_arg(gwi, "float", "_NotchFreq");
  GWI_B(gwi_func_end(gwi, phaser_set_NotchFreq, ae_flag_none))
  gwi_func_ini(gwi, "float", "VibratoMode");
  GWI_B(gwi_func_end(gwi, phaser_get_VibratoMode, ae_flag_none))
  gwi_func_ini(gwi, "float", "VibratoMode");
     gwinote(gwi, "1 or 0");
     gwi_func_arg(gwi, "float", "_VibratoMode");
  GWI_B(gwi_func_end(gwi, phaser_set_VibratoMode, ae_flag_none))
  gwi_func_ini(gwi, "float", "depth");
  GWI_B(gwi_func_end(gwi, phaser_get_depth, ae_flag_none))
  gwi_func_ini(gwi, "float", "depth");
     gwinote(gwi, "Between 0 and 1");
     gwi_func_arg(gwi, "float", "_depth");
  GWI_B(gwi_func_end(gwi, phaser_set_depth, ae_flag_none))
  gwi_func_ini(gwi, "float", "feedback_gain");
  GWI_B(gwi_func_end(gwi, phaser_get_feedback_gain, ae_flag_none))
  gwi_func_ini(gwi, "float", "feedback_gain");
     gwinote(gwi, "Between 0 and 1");
     gwi_func_arg(gwi, "float", "_feedback_gain");
  GWI_B(gwi_func_end(gwi, phaser_set_feedback_gain, ae_flag_none))
  gwi_func_ini(gwi, "float", "invert");
  GWI_B(gwi_func_end(gwi, phaser_get_invert, ae_flag_none))
  gwi_func_ini(gwi, "float", "invert");
     gwinote(gwi, "1 or 0");
     gwi_func_arg(gwi, "float", "_invert");
  GWI_B(gwi_func_end(gwi, phaser_set_invert, ae_flag_none))
  gwi_func_ini(gwi, "float", "level");
  GWI_B(gwi_func_end(gwi, phaser_get_level, ae_flag_none))
  gwi_func_ini(gwi, "float", "level");
     gwinote(gwi, "-60 to 10 dB");
     gwi_func_arg(gwi, "float", "_level");
  GWI_B(gwi_func_end(gwi, phaser_set_level, ae_flag_none))
  gwi_func_ini(gwi, "float", "lfobpm");
  GWI_B(gwi_func_end(gwi, phaser_get_lfobpm, ae_flag_none))
  gwi_func_ini(gwi, "float", "lfobpm");
     gwinote(gwi, "Between 24 and 360");
     gwi_func_arg(gwi, "float", "_lfobpm");
  GWI_B(gwi_func_end(gwi, phaser_set_lfobpm, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_phasor, = gwi_class_ini(gwi, "Phasor", "UGen"));
  SET_FLAG(t_phasor, final);
  gwi_class_xtor(gwi, NULL, phasor_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "initial phase");
     gwi_func_arg(gwi, "float", "_iphs");
  GWI_B(gwi_func_end(gwi, phasor_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, phasor_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, phasor_set_freq, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Pink pinknoise generator");
  DECL_B(const Type, t_pinknoise, = gwi_class_ini(gwi, "Pinknoise", "UGen"));
  SET_FLAG(t_pinknoise, final);
  gwi_class_xtor(gwi, NULL, pinknoise_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, pinknoise_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, pinknoise_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude. (Value between 0-1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, pinknoise_set_amp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_pitchamdf, = gwi_class_ini(gwi, "Pitchamdf", "UGen"));
  ...
  gwi_func_ini(gwi, "auto", "new");
     ...
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, pitchamdf_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Karplus-Strong plucked string instrument.");
  DECL_B(const Type, t_pluck, = gwi_class_ini(gwi, "Pluck", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, pluck_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, pluck_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     ...
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, pluck_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, pluck_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, pluck_set_amp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_port, = gwi_class_ini(gwi, "Port", "UGen"));
  SET_FLAG(t_port, final);
  gwi_class_xtor(gwi, NULL, port_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwi_func_arg(gwi, "float", "_htime");
  GWI_B(gwi_func_end(gwi, port_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "htime");
  GWI_B(gwi_func_end(gwi, port_get_htime, ae_flag_none))
  gwi_func_ini(gwi, "float", "htime");
     gwi_func_arg(gwi, "float", "_htime");
  GWI_B(gwi_func_end(gwi, port_set_htime, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, " High-precision table-lookup posc3ilator with cubic interpolation");
  DECL_B(const Type, t_posc3, = gwi_class_ini(gwi, "Posc3", "UGen"));
  SET_FLAG(t_posc3, final);
  gwi_class_xtor(gwi, NULL, posc3_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "Wavetable to read from. Note: the size of this table must be a power of 2.");
     gwi_func_arg(gwi, "ftbl", "_tbl");
  GWI_B(gwi_func_end(gwi, posc3_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, posc3_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency (in Hz)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, posc3_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
  GWI_B(gwi_func_end(gwi, posc3_get_amp, ae_flag_none))
  gwi_func_ini(gwi, "float", "amp");
     gwinote(gwi, "Amplitude (typically a value between 0 and 1).");
     gwi_func_arg(gwi, "float", "_amp");
  GWI_B(gwi_func_end(gwi, posc3_set_amp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_progress, = gwi_class_ini(gwi, "Progress", "UGen"));
  SET_FLAG(t_progress, final);
  gwi_class_xtor(gwi, NULL, progress_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, progress_init, ae_flag_none))
  gwi_func_ini(gwi, "int", "nbars");
  GWI_B(gwi_func_end(gwi, progress_get_nbars, ae_flag_none))
  gwi_func_ini(gwi, "int", "nbars");
     gwi_func_arg(gwi, "int", "_nbars");
  GWI_B(gwi_func_end(gwi, progress_set_nbars, ae_flag_none))
  gwi_func_ini(gwi, "int", "skip");
  GWI_B(gwi_func_end(gwi, progress_get_skip, ae_flag_none))
  gwi_func_ini(gwi, "int", "skip");
     gwinote(gwi, "How many samples to skip before checking");
     gwi_func_arg(gwi, "int", "_skip");
  GWI_B(gwi_func_end(gwi, progress_set_skip, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_prop, = gwi_class_ini(gwi, "Prop", "UGen"));
  SET_FLAG(t_prop, final);
  gwi_class_xtor(gwi, NULL, prop_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "Prop string to be parsed.");
     gwi_func_arg(gwi, "string", "_str");
  GWI_B(gwi_func_end(gwi, prop_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "bpm");
  GWI_B(gwi_func_end(gwi, prop_get_bpm, ae_flag_none))
  gwi_func_ini(gwi, "float", "bpm");
     gwinote(gwi, "Beats per minute of the prop string.");
     gwi_func_arg(gwi, "float", "_bpm");
  GWI_B(gwi_func_end(gwi, prop_set_bpm, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Time-domain pitch shifter.");
  DECL_B(const Type, t_pshift, = gwi_class_ini(gwi, "Pshift", "UGen"));
  SET_FLAG(t_pshift, final);
  gwi_class_xtor(gwi, NULL, pshift_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, pshift_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "shift");
  GWI_B(gwi_func_end(gwi, pshift_get_shift, ae_flag_none))
  gwi_func_ini(gwi, "float", "shift");
     gwinote(gwi, "Pitch shift (in semitones), range -24/24.");
     gwi_func_arg(gwi, "float", "_shift");
  GWI_B(gwi_func_end(gwi, pshift_set_shift, ae_flag_none))
  gwi_func_ini(gwi, "float", "window");
  GWI_B(gwi_func_end(gwi, pshift_get_window, ae_flag_none))
  gwi_func_ini(gwi, "float", "window");
     gwinote(gwi, "Window size (in samples), max 10000");
     gwi_func_arg(gwi, "float", "_window");
  GWI_B(gwi_func_end(gwi, pshift_set_window, ae_flag_none))
  gwi_func_ini(gwi, "float", "xfade");
  GWI_B(gwi_func_end(gwi, pshift_get_xfade, ae_flag_none))
  gwi_func_ini(gwi, "float", "xfade");
     gwinote(gwi, "Crossfade (in samples), max 10000");
     gwi_func_arg(gwi, "float", "_xfade");
  GWI_B(gwi_func_end(gwi, pshift_set_xfade, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_ptrack, = gwi_class_ini(gwi, "Ptrack", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, ptrack_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_randh, = gwi_class_ini(gwi, "Randh", "UGen"));
  SET_FLAG(t_randh, final);
  gwi_class_xtor(gwi, NULL, randh_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, randh_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
  GWI_B(gwi_func_end(gwi, randh_get_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
     gwinote(gwi, "Minimum value to use.");
     gwi_func_arg(gwi, "float", "_min");
  GWI_B(gwi_func_end(gwi, randh_set_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
  GWI_B(gwi_func_end(gwi, randh_get_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
     gwinote(gwi, "Maximum value to use.");
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, randh_set_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, randh_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Frequency of randomization (in Hz)");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, randh_set_freq, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Line segments between random values within a range");
  DECL_B(const Type, t_randi, = gwi_class_ini(gwi, "Randi", "UGen"));
  SET_FLAG(t_randi, final);
  gwi_class_xtor(gwi, NULL, randi_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, randi_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
  GWI_B(gwi_func_end(gwi, randi_get_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
     gwinote(gwi, "Minimum value");
     gwi_func_arg(gwi, "float", "_min");
  GWI_B(gwi_func_end(gwi, randi_set_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
  GWI_B(gwi_func_end(gwi, randi_get_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
     gwinote(gwi, "Maximum value");
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, randi_set_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "cps");
  GWI_B(gwi_func_end(gwi, randi_get_cps, ae_flag_none))
  gwi_func_ini(gwi, "float", "cps");
     gwinote(gwi, "Frequency to change values.");
     gwi_func_arg(gwi, "float", "_cps");
  GWI_B(gwi_func_end(gwi, randi_set_cps, ae_flag_none))
  gwi_func_ini(gwi, "float", "mode");
  GWI_B(gwi_func_end(gwi, randi_get_mode, ae_flag_none))
  gwi_func_ini(gwi, "float", "mode");
     gwinote(gwi, "Randi mode (not yet implemented yet.)");
     gwi_func_arg(gwi, "float", "_mode");
  GWI_B(gwi_func_end(gwi, randi_set_mode, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Random values within a range");
  DECL_B(const Type, t_random, = gwi_class_ini(gwi, "Random", "UGen"));
  SET_FLAG(t_random, final);
  gwi_class_xtor(gwi, NULL, random_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, random_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
  GWI_B(gwi_func_end(gwi, random_get_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
     gwinote(gwi, "Minimum value.");
     gwi_func_arg(gwi, "float", "_min");
  GWI_B(gwi_func_end(gwi, random_set_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
  GWI_B(gwi_func_end(gwi, random_get_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
     gwinote(gwi, "Maximum value.");
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, random_set_max, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_reson, = gwi_class_ini(gwi, "Reson", "UGen"));
  SET_FLAG(t_reson, final);
  gwi_class_xtor(gwi, NULL, reson_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, reson_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, reson_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Center frequency of the filter, or frequency position of the peak response.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, reson_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "bw");
  GWI_B(gwi_func_end(gwi, reson_get_bw, ae_flag_none))
  gwi_func_ini(gwi, "float", "bw");
     gwinote(gwi, "Bandwidth of the filter.");
     gwi_func_arg(gwi, "float", "_bw");
  GWI_B(gwi_func_end(gwi, reson_set_bw, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Signal reverser");
     gwinote(gwi, "	Reverse will store a signal inside a buffer and play it back reversed.");
  DECL_B(const Type, t_reverse, = gwi_class_ini(gwi, "Reverse", "UGen"));
  SET_FLAG(t_reverse, final);
  gwi_class_xtor(gwi, NULL, reverse_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "Delay time in seconds.");
     gwi_func_arg(gwi, "float", "_delay");
  GWI_B(gwi_func_end(gwi, reverse_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, " 8 FDN stereo reverb");
  DECL_B(const Type, t_revsc, = gwi_class_ini(gwi, "Revsc", "UGen"));
  SET_FLAG(t_revsc, final);
  gwi_class_xtor(gwi, NULL, revsc_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, revsc_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "feedback");
  GWI_B(gwi_func_end(gwi, revsc_get_feedback, ae_flag_none))
  gwi_func_ini(gwi, "float", "feedback");
     gwinote(gwi, "Value between 0-1 that sets feedback value. The larger the value, the longer the decay.");
     gwi_func_arg(gwi, "float", "_feedback");
  GWI_B(gwi_func_end(gwi, revsc_set_feedback, ae_flag_none))
  gwi_func_ini(gwi, "float", "lpfreq");
  GWI_B(gwi_func_end(gwi, revsc_get_lpfreq, ae_flag_none))
  gwi_func_ini(gwi, "float", "lpfreq");
     gwinote(gwi, "low pass cutoff frequency.");
     gwi_func_arg(gwi, "float", "_lpfreq");
  GWI_B(gwi_func_end(gwi, revsc_set_lpfreq, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_rms, = gwi_class_ini(gwi, "Rms", "UGen"));
  SET_FLAG(t_rms, final);
  gwi_class_xtor(gwi, NULL, rms_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, rms_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "ihp");
  GWI_B(gwi_func_end(gwi, rms_get_ihp, ae_flag_none))
  gwi_func_ini(gwi, "float", "ihp");
  ...
  GWI_B(gwi_func_end(gwi, rms_set_ihp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_rpt, = gwi_class_ini(gwi, "Rpt", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, rpt_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_rspline, = gwi_class_ini(gwi, "Rspline", "UGen"));
  SET_FLAG(t_rspline, final);
  gwi_class_xtor(gwi, NULL, rspline_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, rspline_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
  GWI_B(gwi_func_end(gwi, rspline_get_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
     gwinote(gwi, "Minimum range.");
     gwi_func_arg(gwi, "float", "_min");
  GWI_B(gwi_func_end(gwi, rspline_set_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
  GWI_B(gwi_func_end(gwi, rspline_get_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
     gwinote(gwi, "Maximum range");
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, rspline_set_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "cps_min");
  GWI_B(gwi_func_end(gwi, rspline_get_cps_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "cps_min");
     gwi_func_arg(gwi, "float", "_cps_min");
  GWI_B(gwi_func_end(gwi, rspline_set_cps_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "cps_max");
  GWI_B(gwi_func_end(gwi, rspline_get_cps_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "cps_max");
     gwi_func_arg(gwi, "float", "_cps_max");
  GWI_B(gwi_func_end(gwi, rspline_set_cps_max, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Classic sample and hold");
  DECL_B(const Type, t_samphold, = gwi_class_ini(gwi, "Samphold", "UGen"));
  SET_FLAG(t_samphold, final);
  gwi_class_xtor(gwi, NULL, samphold_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, samphold_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Soft clip saturating distortion, based on examples from Abel/Berners' Music 424 course at Stanford.");
  DECL_B(const Type, t_saturator, = gwi_class_ini(gwi, "Saturator", "UGen"));
  SET_FLAG(t_saturator, final);
  gwi_class_xtor(gwi, NULL, saturator_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, saturator_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "drive");
  GWI_B(gwi_func_end(gwi, saturator_get_drive, ae_flag_none))
  gwi_func_ini(gwi, "float", "drive");
  ...
  GWI_B(gwi_func_end(gwi, saturator_set_drive, ae_flag_none))
  gwi_func_ini(gwi, "float", "dcoffset");
  GWI_B(gwi_func_end(gwi, saturator_get_dcoffset, ae_flag_none))
  gwi_func_ini(gwi, "float", "dcoffset");
  ...
  GWI_B(gwi_func_end(gwi, saturator_set_dcoffset, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Bipolar Scale");
     gwinote(gwi, "    This module scales from unipolar [0, 1] to another range defined by min and max.");
  DECL_B(const Type, t_scale, = gwi_class_ini(gwi, "Scale", "UGen"));
  SET_FLAG(t_scale, final);
  gwi_class_xtor(gwi, NULL, scale_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, scale_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
  GWI_B(gwi_func_end(gwi, scale_get_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
     gwinote(gwi, "Minimum value to scale to.");
     gwi_func_arg(gwi, "float", "_min");
  GWI_B(gwi_func_end(gwi, scale_set_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
  GWI_B(gwi_func_end(gwi, scale_get_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
     gwinote(gwi, "Maximum value to scale to.");
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, scale_set_max, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Delays a signal by a number of samples.");
  DECL_B(const Type, t_sdelay, = gwi_class_ini(gwi, "Sdelay", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, sdelay_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_slice, = gwi_class_ini(gwi, "Slice", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, slice_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "id");
  GWI_B(gwi_func_end(gwi, slice_get_id, ae_flag_none))
  gwi_func_ini(gwi, "float", "id");
     gwinote(gwi, "Value position.");
     gwi_func_arg(gwi, "float", "_id");
  GWI_B(gwi_func_end(gwi, slice_set_id, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_smoothdelay, = gwi_class_ini(gwi, "Smoothdelay", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, smoothdelay_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "feedback");
  GWI_B(gwi_func_end(gwi, smoothdelay_get_feedback, ae_flag_none))
  gwi_func_ini(gwi, "float", "feedback");
     gwi_func_arg(gwi, "float", "_feedback");
  GWI_B(gwi_func_end(gwi, smoothdelay_set_feedback, ae_flag_none))
  gwi_func_ini(gwi, "float", "del");
  GWI_B(gwi_func_end(gwi, smoothdelay_get_del, ae_flag_none))
  gwi_func_ini(gwi, "float", "del");
     gwi_func_arg(gwi, "float", "_del");
  GWI_B(gwi_func_end(gwi, smoothdelay_set_del, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_spa, = gwi_class_ini(gwi, "Spa", "UGen"));
  SET_FLAG(t_spa, final);
  gwi_class_xtor(gwi, NULL, spa_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "Filename of SPA file");
     gwi_func_arg(gwi, "string", "_filename");
  GWI_B(gwi_func_end(gwi, spa_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Writes signal to spa file.");
  DECL_B(const Type, t_sparec, = gwi_class_ini(gwi, "Sparec", "UGen"));
  SET_FLAG(t_sparec, final);
  gwi_class_xtor(gwi, NULL, sparec_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "Filename to write to");
     gwi_func_arg(gwi, "string", "_filename");
  GWI_B(gwi_func_end(gwi, sparec_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "String resonator filter");
  DECL_B(const Type, t_streson, = gwi_class_ini(gwi, "Streson", "UGen"));
  SET_FLAG(t_streson, final);
  gwi_class_xtor(gwi, NULL, streson_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, streson_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
  GWI_B(gwi_func_end(gwi, streson_get_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "freq");
     gwinote(gwi, "Fundamental frequency of string.");
     gwi_func_arg(gwi, "float", "_freq");
  GWI_B(gwi_func_end(gwi, streson_set_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "fdbgain");
  GWI_B(gwi_func_end(gwi, streson_get_fdbgain, ae_flag_none))
  gwi_func_ini(gwi, "float", "fdbgain");
     gwinote(gwi, "Feedback amount (value between 0-1)");
     gwi_func_arg(gwi, "float", "_fdbgain");
  GWI_B(gwi_func_end(gwi, streson_set_fdbgain, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_switch, = gwi_class_ini(gwi, "Switch", "UGen"));
  SET_FLAG(t_switch, final);
  gwi_class_xtor(gwi, NULL, switch_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, switch_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Table ");
     gwinote(gwi, "        Read through an sp_ftbl with linear interpolation.");
     gwinote(gwi, "    ");
  DECL_B(const Type, t_tabread, = gwi_class_ini(gwi, "Tabread", "UGen"));
  ...
  gwi_func_ini(gwi, "auto", "new");
     ...
     gwi_func_arg(gwi, "float", "_mode");
  GWI_B(gwi_func_end(gwi, tabread_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "index");
  GWI_B(gwi_func_end(gwi, tabread_get_index, ae_flag_none))
  gwi_func_ini(gwi, "float", "index");
     gwinote(gwi, "index position, either scaled or unscaled with mode parameter");
     gwi_func_arg(gwi, "float", "_index");
  GWI_B(gwi_func_end(gwi, tabread_set_index, ae_flag_none))
  gwi_func_ini(gwi, "float", "offset");
  GWI_B(gwi_func_end(gwi, tabread_get_offset, ae_flag_none))
  gwi_func_ini(gwi, "float", "offset");
  ...
  GWI_B(gwi_func_end(gwi, tabread_set_offset, ae_flag_none))
  gwi_func_ini(gwi, "float", "wrap");
  GWI_B(gwi_func_end(gwi, tabread_get_wrap, ae_flag_none))
  gwi_func_ini(gwi, "float", "wrap");
     gwinote(gwi, "Enable wraparound. 1 = on; 0 = 0ff.");
     gwi_func_arg(gwi, "float", "_wrap");
  GWI_B(gwi_func_end(gwi, tabread_set_wrap, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Triggerable classic ADSR envelope");
  DECL_B(const Type, t_tadsr, = gwi_class_ini(gwi, "Tadsr", "UGen"));
  SET_FLAG(t_tadsr, final);
  gwi_class_xtor(gwi, NULL, tadsr_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tadsr_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, tadsr_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Attack time");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, tadsr_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
  GWI_B(gwi_func_end(gwi, tadsr_get_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "dec");
     gwinote(gwi, "Decay time");
     gwi_func_arg(gwi, "float", "_dec");
  GWI_B(gwi_func_end(gwi, tadsr_set_dec, ae_flag_none))
  gwi_func_ini(gwi, "float", "sus");
  GWI_B(gwi_func_end(gwi, tadsr_get_sus, ae_flag_none))
  gwi_func_ini(gwi, "float", "sus");
     gwinote(gwi, "Sustain Level");
     gwi_func_arg(gwi, "float", "_sus");
  GWI_B(gwi_func_end(gwi, tadsr_set_sus, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
  GWI_B(gwi_func_end(gwi, tadsr_get_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
     gwinote(gwi, "release");
     gwi_func_arg(gwi, "float", "_rel");
  GWI_B(gwi_func_end(gwi, tadsr_set_rel, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_talkbox, = gwi_class_ini(gwi, "Talkbox", "UGen"));
  SET_FLAG(t_talkbox, final);
  gwi_class_xtor(gwi, NULL, talkbox_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, talkbox_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "quality");
  GWI_B(gwi_func_end(gwi, talkbox_get_quality, ae_flag_none))
  gwi_func_ini(gwi, "float", "quality");
     gwinote(gwi, "Quality of the talkbox sound. 0=lowest fidelity. 1=highest fidelity");
     gwi_func_arg(gwi, "float", "_quality");
  GWI_B(gwi_func_end(gwi, talkbox_set_quality, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_tblrec, = gwi_class_ini(gwi, "Tblrec", "UGen"));
  SET_FLAG(t_tblrec, final);
  gwi_class_xtor(gwi, NULL, tblrec_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwi_func_arg(gwi, "ftbl", "_bar");
  GWI_B(gwi_func_end(gwi, tblrec_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Emulation of the Roland TB-303 filter");
  DECL_B(const Type, t_tbvcf, = gwi_class_ini(gwi, "Tbvcf", "UGen"));
  SET_FLAG(t_tbvcf, final);
  gwi_class_xtor(gwi, NULL, tbvcf_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tbvcf_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "fco");
  GWI_B(gwi_func_end(gwi, tbvcf_get_fco, ae_flag_none))
  gwi_func_ini(gwi, "float", "fco");
     gwinote(gwi, "Filter cutoff frequency");
     gwi_func_arg(gwi, "float", "_fco");
  GWI_B(gwi_func_end(gwi, tbvcf_set_fco, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
  GWI_B(gwi_func_end(gwi, tbvcf_get_res, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
     gwinote(gwi, "Resonance");
     gwi_func_arg(gwi, "float", "_res");
  GWI_B(gwi_func_end(gwi, tbvcf_set_res, ae_flag_none))
  gwi_func_ini(gwi, "float", "dist");
  GWI_B(gwi_func_end(gwi, tbvcf_get_dist, ae_flag_none))
  gwi_func_ini(gwi, "float", "dist");
     gwinote(gwi, "Distortion. Value is typically 2.0; deviation from this can cause stability issues. ");
     gwi_func_arg(gwi, "float", "_dist");
  GWI_B(gwi_func_end(gwi, tbvcf_set_dist, ae_flag_none))
  gwi_func_ini(gwi, "float", "asym");
  GWI_B(gwi_func_end(gwi, tbvcf_get_asym, ae_flag_none))
  gwi_func_ini(gwi, "float", "asym");
     gwinote(gwi, "Asymmetry of resonance. Value is between 0-1");
     gwi_func_arg(gwi, "float", "_asym");
  GWI_B(gwi_func_end(gwi, tbvcf_set_asym, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
     ...
     gwinote(gwi, "in: * * * * * * * * *");
     gwinote(gwi, "out *     *     *   ");
  DECL_B(const Type, t_tdiv, = gwi_class_ini(gwi, "Tdiv", "UGen"));
  SET_FLAG(t_tdiv, final);
  gwi_class_xtor(gwi, NULL, tdiv_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tdiv_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "num");
  GWI_B(gwi_func_end(gwi, tdiv_get_num, ae_flag_none))
  gwi_func_ini(gwi, "float", "num");
     gwinote(gwi, "Triggers every N times.");
     gwi_func_arg(gwi, "float", "_num");
  GWI_B(gwi_func_end(gwi, tdiv_set_num, ae_flag_none))
  gwi_func_ini(gwi, "float", "offset");
  GWI_B(gwi_func_end(gwi, tdiv_get_offset, ae_flag_none))
  gwi_func_ini(gwi, "float", "offset");
     gwinote(gwi, "Offset amoutn.");
     gwi_func_arg(gwi, "float", "_offset");
  GWI_B(gwi_func_end(gwi, tdiv_set_offset, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Trigger based linear AHD envelope generator");
  DECL_B(const Type, t_tenv, = gwi_class_ini(gwi, "Tenv", "UGen"));
  SET_FLAG(t_tenv, final);
  gwi_class_xtor(gwi, NULL, tenv_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tenv_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, tenv_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Attack time, in seconds.");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, tenv_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "hold");
  GWI_B(gwi_func_end(gwi, tenv_get_hold, ae_flag_none))
  gwi_func_ini(gwi, "float", "hold");
     gwinote(gwi, "Hold time, in seconds.");
     gwi_func_arg(gwi, "float", "_hold");
  GWI_B(gwi_func_end(gwi, tenv_set_hold, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
  GWI_B(gwi_func_end(gwi, tenv_get_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
     gwinote(gwi, "Release time, in seconds.");
     gwi_func_arg(gwi, "float", "_rel");
  GWI_B(gwi_func_end(gwi, tenv_set_rel, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_tenv2, = gwi_class_ini(gwi, "Tenv2", "UGen"));
  SET_FLAG(t_tenv2, final);
  gwi_class_xtor(gwi, NULL, tenv2_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tenv2_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, tenv2_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Attack time (in seconds).");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, tenv2_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
  GWI_B(gwi_func_end(gwi, tenv2_get_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
     gwinote(gwi, "Release time (in seconds).");
     gwi_func_arg(gwi, "float", "_rel");
  GWI_B(gwi_func_end(gwi, tenv2_set_rel, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
     ...
     gwinote(gwi, "    ");
  DECL_B(const Type, t_tenvx, = gwi_class_ini(gwi, "Tenvx", "UGen"));
  SET_FLAG(t_tenvx, final);
  gwi_class_xtor(gwi, NULL, tenvx_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tenvx_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, tenvx_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Tau attack time, in seconds. Must be non-zero.");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, tenvx_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "hold");
  GWI_B(gwi_func_end(gwi, tenvx_get_hold, ae_flag_none))
  gwi_func_ini(gwi, "float", "hold");
     gwinote(gwi, "Hold time, in seconds. The duration of the gate signal.");
     gwi_func_arg(gwi, "float", "_hold");
  GWI_B(gwi_func_end(gwi, tenvx_set_hold, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
  GWI_B(gwi_func_end(gwi, tenvx_get_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
     gwinote(gwi, "Tau release time, in seconds. Must be non-zero.");
     gwi_func_arg(gwi, "float", "_rel");
  GWI_B(gwi_func_end(gwi, tenvx_set_rel, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "A triggerable gate.");
  DECL_B(const Type, t_tgate, = gwi_class_ini(gwi, "Tgate", "UGen"));
  SET_FLAG(t_tgate, final);
  gwi_class_xtor(gwi, NULL, tgate_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tgate_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "time");
  GWI_B(gwi_func_end(gwi, tgate_get_time, ae_flag_none))
  gwi_func_ini(gwi, "float", "time");
     gwinote(gwi, "Duration of the gate (in seconds)");
     gwi_func_arg(gwi, "float", "_time");
  GWI_B(gwi_func_end(gwi, tgate_set_time, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Trigger generator for signals that cross a given threshold. ");
  DECL_B(const Type, t_thresh, = gwi_class_ini(gwi, "Thresh", "UGen"));
  SET_FLAG(t_thresh, final);
  gwi_class_xtor(gwi, NULL, thresh_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, thresh_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "thresh");
  GWI_B(gwi_func_end(gwi, thresh_get_thresh, ae_flag_none))
  gwi_func_ini(gwi, "float", "thresh");
     gwinote(gwi, "Threshold level");
     gwi_func_arg(gwi, "float", "_thresh");
  GWI_B(gwi_func_end(gwi, thresh_set_thresh, ae_flag_none))
  gwi_func_ini(gwi, "int", "mode");
  GWI_B(gwi_func_end(gwi, thresh_get_mode, ae_flag_none))
  gwi_func_ini(gwi, "int", "mode");
     gwinote(gwi, "Sets when to detect theshold crossings. 0 = from below. 1 = from above. 2 = from above/below");
     gwi_func_arg(gwi, "int", "_mode");
  GWI_B(gwi_func_end(gwi, thresh_set_mode, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_timer, = gwi_class_ini(gwi, "Timer", "UGen"));
  SET_FLAG(t_timer, final);
  gwi_class_xtor(gwi, NULL, timer_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, timer_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_tin, = gwi_class_ini(gwi, "Tin", "UGen"));
  SET_FLAG(t_tin, final);
  gwi_class_xtor(gwi, NULL, tin_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tin_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "First-order recursive lowpass filter");
  DECL_B(const Type, t_tone, = gwi_class_ini(gwi, "Tone", "UGen"));
  SET_FLAG(t_tone, final);
  gwi_class_xtor(gwi, NULL, tone_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, tone_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "hp");
  GWI_B(gwi_func_end(gwi, tone_get_hp, ae_flag_none))
  gwi_func_ini(gwi, "float", "hp");
     gwinote(gwi, "The response curve's half power point (aka cutoff frequency).");
     gwi_func_arg(gwi, "float", "_hp");
  GWI_B(gwi_func_end(gwi, tone_set_hp, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "Triggered random number generator.");
  DECL_B(const Type, t_trand, = gwi_class_ini(gwi, "Trand", "UGen"));
  SET_FLAG(t_trand, final);
  gwi_class_xtor(gwi, NULL, trand_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, trand_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
  GWI_B(gwi_func_end(gwi, trand_get_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "min");
     gwinote(gwi, "Minimum value to use.");
     gwi_func_arg(gwi, "float", "_min");
  GWI_B(gwi_func_end(gwi, trand_set_min, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
  GWI_B(gwi_func_end(gwi, trand_get_max, ae_flag_none))
  gwi_func_ini(gwi, "float", "max");
     gwinote(gwi, "Maximum value to use.");
     gwi_func_arg(gwi, "float", "_max");
  GWI_B(gwi_func_end(gwi, trand_set_max, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "This module creates a series of line segments. ");
  DECL_B(const Type, t_tseg, = gwi_class_ini(gwi, "Tseg", "UGen"));
  SET_FLAG(t_tseg, final);
  gwi_class_xtor(gwi, NULL, tseg_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "Beginning value.");
     gwi_func_arg(gwi, "float", "_ibeg");
  GWI_B(gwi_func_end(gwi, tseg_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "end");
  GWI_B(gwi_func_end(gwi, tseg_get_end, ae_flag_none))
  gwi_func_ini(gwi, "float", "end");
     gwinote(gwi, "End parameter to go to.");
     gwi_func_arg(gwi, "float", "_end");
  GWI_B(gwi_func_end(gwi, tseg_set_end, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
  GWI_B(gwi_func_end(gwi, tseg_get_dur, ae_flag_none))
  gwi_func_ini(gwi, "float", "dur");
     gwinote(gwi, "duration to rise to (in seconds).");
     gwi_func_arg(gwi, "float", "_dur");
  GWI_B(gwi_func_end(gwi, tseg_set_dur, ae_flag_none))
  gwi_func_ini(gwi, "float", "type");
  GWI_B(gwi_func_end(gwi, tseg_get_type, ae_flag_none))
  gwi_func_ini(gwi, "float", "type");
     gwinote(gwi, "The type of line, which determines slope of line");
     gwi_func_arg(gwi, "float", "_type");
  GWI_B(gwi_func_end(gwi, tseg_set_type, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  gwi_func_ini(gwi, "float", "del");
     ...
     gwi_func_arg(gwi, "float", "_del");
  GWI_B(gwi_func_end(gwi, vdelay_set_del, ae_flag_none))
  gwi_func_ini(gwi, "float", "feedback");
  GWI_B(gwi_func_end(gwi, vdelay_get_feedback, ae_flag_none))
  gwi_func_ini(gwi, "float", "feedback");
     gwinote(gwi, "Amount of feedback in delay line. Should be in range 0-1.");
     gwi_func_arg(gwi, "float", "_feedback");
  GWI_B(gwi_func_end(gwi, vdelay_set_feedback, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_voc, = gwi_class_ini(gwi, "Voc", "UGen"));
  SET_FLAG(t_voc, final);
  gwi_class_xtor(gwi, NULL, voc_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, voc_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "16-band channel vocoder");
  DECL_B(const Type, t_vocoder, = gwi_class_ini(gwi, "Vocoder", "UGen"));
  SET_FLAG(t_vocoder, final);
  gwi_class_xtor(gwi, NULL, vocoder_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, vocoder_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
  GWI_B(gwi_func_end(gwi, vocoder_get_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "atk");
     gwinote(gwi, "Attack time . (Range 0.001 and 0.5 seconds)");
     gwi_func_arg(gwi, "float", "_atk");
  GWI_B(gwi_func_end(gwi, vocoder_set_atk, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
  GWI_B(gwi_func_end(gwi, vocoder_get_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "rel");
     gwinote(gwi, "Release time");
     gwi_func_arg(gwi, "float", "_rel");
  GWI_B(gwi_func_end(gwi, vocoder_set_rel, ae_flag_none))
  gwi_func_ini(gwi, "float", "bwratio");
  GWI_B(gwi_func_end(gwi, vocoder_get_bwratio, ae_flag_none))
  gwi_func_ini(gwi, "float", "bwratio");
     gwinote(gwi, "Coeffecient to adjust the bandwidth of each band (0.1 - 2)");
     gwi_func_arg(gwi, "float", "_bwratio");
  GWI_B(gwi_func_end(gwi, vocoder_set_bwratio, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_waveset, = gwi_class_ini(gwi, "Waveset", "UGen"));
  ...
  GWI_B(gwi_func_end(gwi, waveset_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "rep");
  GWI_B(gwi_func_end(gwi, waveset_get_rep, ae_flag_none))
  gwi_func_ini(gwi, "float", "rep");
     gwinote(gwi, "Number of repeats.");
     gwi_func_arg(gwi, "float", "_rep");
  GWI_B(gwi_func_end(gwi, waveset_set_rep, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_wavin, = gwi_class_ini(gwi, "Wavin", "UGen"));
  SET_FLAG(t_wavin, final);
  gwi_class_xtor(gwi, NULL, wavin_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "Filename");
     gwi_func_arg(gwi, "string", "_filename");
  GWI_B(gwi_func_end(gwi, wavin_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_wavout, = gwi_class_ini(gwi, "Wavout", "UGen"));
  SET_FLAG(t_wavout, final);
  gwi_class_xtor(gwi, NULL, wavout_dtor);
  gwi_func_ini(gwi, "auto", "new");
     gwinote(gwi, "The filename of the output file.");
     gwi_func_arg(gwi, "string", "_filename");
  GWI_B(gwi_func_end(gwi, wavout_init, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
  ...
  DECL_B(const Type, t_wpkorg35, = gwi_class_ini(gwi, "Wpkorg35", "UGen"));
  SET_FLAG(t_wpkorg35, final);
  gwi_class_xtor(gwi, NULL, wpkorg35_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, wpkorg35_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "cutoff");
  GWI_B(gwi_func_end(gwi, wpkorg35_get_cutoff, ae_flag_none))
  gwi_func_ini(gwi, "float", "cutoff");
     gwinote(gwi, "Filter cutoff");
     gwi_func_arg(gwi, "float", "_cutoff");
  GWI_B(gwi_func_end(gwi, wpkorg35_set_cutoff, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
  GWI_B(gwi_func_end(gwi, wpkorg35_get_res, ae_flag_none))
  gwi_func_ini(gwi, "float", "res");
     gwinote(gwi, "Filter resonance (should be between 0-2)");
     gwi_func_arg(gwi, "float", "_res");
  GWI_B(gwi_func_end(gwi, wpkorg35_set_res, ae_flag_none))
  gwi_func_ini(gwi, "float", "saturation");
  GWI_B(gwi_func_end(gwi, wpkorg35_get_saturation, ae_flag_none))
  gwi_func_ini(gwi, "float", "saturation");
     gwinote(gwi, "Filter saturation.");
     gwi_func_arg(gwi, "float", "_saturation");
  GWI_B(gwi_func_end(gwi, wpkorg35_set_saturation, ae_flag_none))
  GWI_B(gwi_class_end(gwi))

     gwinote(gwi, "8 FDN stereo zitareverb algorithm, imported from Faust.");
  DECL_B(const Type, t_zitarev, = gwi_class_ini(gwi, "Zitarev", "UGen"));
  SET_FLAG(t_zitarev, final);
  gwi_class_xtor(gwi, NULL, zitarev_dtor);
  gwi_func_ini(gwi, "auto", "new");
  GWI_B(gwi_func_end(gwi, zitarev_init, ae_flag_none))
  gwi_func_ini(gwi, "float", "in_delay");
  GWI_B(gwi_func_end(gwi, zitarev_get_in_delay, ae_flag_none))
  gwi_func_ini(gwi, "float", "in_delay");
     gwinote(gwi, "Delay in ms before reverberation begins.");
     gwi_func_arg(gwi, "float", "_in_delay");
  GWI_B(gwi_func_end(gwi, zitarev_set_in_delay, ae_flag_none))
  gwi_func_ini(gwi, "float", "lf_x");
  GWI_B(gwi_func_end(gwi, zitarev_get_lf_x, ae_flag_none))
  gwi_func_ini(gwi, "float", "lf_x");
     gwinote(gwi, "Crossover frequency separating low and middle frequencies (Hz).");
     gwi_func_arg(gwi, "float", "_lf_x");
  GWI_B(gwi_func_end(gwi, zitarev_set_lf_x, ae_flag_none))
  gwi_func_ini(gwi, "float", "rt60_low");
  GWI_B(gwi_func_end(gwi, zitarev_get_rt60_low, ae_flag_none))
  gwi_func_ini(gwi, "float", "rt60_low");
     gwinote(gwi, "Time (in seconds) to decay 60db in low-frequency band.");
     gwi_func_arg(gwi, "float", "_rt60_low");
  GWI_B(gwi_func_end(gwi, zitarev_set_rt60_low, ae_flag_none))
  gwi_func_ini(gwi, "float", "rt60_mid");
  GWI_B(gwi_func_end(gwi, zitarev_get_rt60_mid, ae_flag_none))
  gwi_func_ini(gwi, "float", "rt60_mid");
     gwinote(gwi, "Time (in seconds) to decay 60db in mid-frequency band.");
     gwi_func_arg(gwi, "float", "_rt60_mid");
  GWI_B(gwi_func_end(gwi, zitarev_set_rt60_mid, ae_flag_none))
  gwi_func_ini(gwi, "float", "hf_damping");
  GWI_B(gwi_func_end(gwi, zitarev_get_hf_damping, ae_flag_none))
  gwi_func_ini(gwi, "float", "hf_damping");
     gwinote(gwi, "Frequency (Hz) at which the high-frequency T60 is half the middle-band's T60.");
     gwi_func_arg(gwi, "float", "_hf_damping");
  GWI_B(gwi_func_end(gwi, zitarev_set_hf_damping, ae_flag_none))
  gwi_func_ini(gwi, "float", "eq1_freq");
  GWI_B(gwi_func_end(gwi, zitarev_get_eq1_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "eq1_freq");
     gwinote(gwi, "Center frequency of second-order Regalia Mitra peaking equalizer section 1.");
     gwi_func_arg(gwi, "float", "_eq1_freq");
  GWI_B(gwi_func_end(gwi, zitarev_set_eq1_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "eq1_level");
  GWI_B(gwi_func_end(gwi, zitarev_get_eq1_level, ae_flag_none))
  gwi_func_ini(gwi, "float", "eq1_level");
     gwinote(gwi, "Peak level in dB of second-order Regalia-Mitra peaking equalizer section 1");
     gwi_func_arg(gwi, "float", "_eq1_level");
  GWI_B(gwi_func_end(gwi, zitarev_set_eq1_level, ae_flag_none))
  gwi_func_ini(gwi, "float", "eq2_freq");
  GWI_B(gwi_func_end(gwi, zitarev_get_eq2_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "eq2_freq");
     gwinote(gwi, "Center frequency of second-order Regalia Mitra peaking equalizer section 2.");
     gwi_func_arg(gwi, "float", "_eq2_freq");
  GWI_B(gwi_func_end(gwi, zitarev_set_eq2_freq, ae_flag_none))
  gwi_func_ini(gwi, "float", "eq2_level");
  GWI_B(gwi_func_end(gwi, zitarev_get_eq2_level, ae_flag_none))
  gwi_func_ini(gwi, "float", "eq2_level");
     gwinote(gwi, "Peak level in dB of second-order Regalia-Mitra peaking equalizer section 2");
     gwi_func_arg(gwi, "float", "_eq2_level");
  GWI_B(gwi_func_end(gwi, zitarev_set_eq2_level, ae_flag_none))
  gwi_func_ini(gwi, "float", "mix");
  GWI_B(gwi_func_end(gwi, zitarev_get_mix, ae_flag_none))
  gwi_func_ini(gwi, "float", "mix");
     gwinote(gwi, "0 = all dry, 1 = all wet");
     gwi_func_arg(gwi, "float", "_mix");
  GWI_B(gwi_func_end(gwi, zitarev_set_mix, ae_flag_none))
  gwi_func_ini(gwi, "float", "level");
  GWI_B(gwi_func_end(gwi, zitarev_get_level, ae_flag_none))
  gwi_func_ini(gwi, "float", "level");
     gwinote(gwi, "Output scale factor (in dB).");
     gwi_func_arg(gwi, "float", "_level");
  GWI_B(gwi_func_end(gwi, zitarev_set_level, ae_flag_none))
  GWI_B(gwi_class_end(gwi))
